...
FLAGS = -DNDEBUG -D$(EVAL_TYPE) -DNANOHA -DCHK_PERFORM  \
	-DOLD_LOCKS /favor:INTEL64 /EHsc /D_CRT_SECURE_NO_WARNINGS \
	 /GL /Zc:forScope
#CXXFLAGS=$(FLAGS) /MT /W4 /Wall /nologo /Od /GS /RTCsu
CXXFLAGS=$(FLAGS)  /W3 /nologo /Ox /Ob2 /GS- /Gm /Zi /GL /O2  /GT /WX-  /arch:AVX2 /Gr /Oi /MT  /EHsc  /Ot
LDFLAGS=/NOLOGO /STACK:16777216,32768 /out:$(EXE) /LTCG /NDEBUG
