...
TEST (CommandPacketTest, setposition_test)
{
    ...
    ASSERT_EQ(10, command->position_id());
    ASSERT_EQ(INITIAL_SFEN, command->position_sfen());
    ASSERT_EQ(commandStr, command->toRSI());

    //
    sfen = "l8/4+R4/1L2pgn2/1Ps1k2S1/P2p1SP2/LlP2b2p/ppNGP4/2S6/2KG5 w RBG6P2n2p";
    commandStr = "setposition 0 sfen " + sfen;
    command = CommandPacket::parse(commandStr);

    ASSERT_EQ(0, command->position_id());
    ASSERT_EQ(sfen, command->position_sfen());
    ASSERT_EQ(commandStr, command->toRSI());
    ...
    sfen0 = "l8/4+R4/1L2pgn2/1Ps1k2S1/P2p1SP2/LlP2b2p/ppNGP4/2S6/2KG5 w RBG6P2n2p";
...
TEST (CommandPacketTest, setposition_error_test)
{
